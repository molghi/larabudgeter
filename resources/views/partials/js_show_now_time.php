<script>
    function showTime () {
        ...
        document.body.insertAdjacentHTML('beforeend', `<div title="${title}" class="time font-mono text-[12px] text-[#333] hover:text-[#eee] bg-black transition hover:scale-125 fixed bottom-[5px] left-[5px] rounded hover:translate-x-4 p-1 px-2">
            <div>${date}</div>
            <div>${timeEl}</div>
        </div>`)
    }
